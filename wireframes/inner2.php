...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./css/inner2.css">
  ...
  <body>
    ...
    <div id="main-content" class="container-fluid">
      ...
      <ul class="nav nav-pills habits-filter">
        <li role="presentation" class="active"><a href="#">My Habits</a></li>
        <li role="presentation"><a href="#">Community Habits</a></li>
      </ul>

      <div class="habits-wrapper">
          

          <div class="habit-instance">  
            <div class="row">
              <div class="col-md-6 col-xs-8">
                <input class="form-control habit-instance-name" placeholder="Habit name." />
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-8 col-xs-12">
                <textarea class="form-control" placeholder="(optional) Enter a small description about this habit"></textarea>
              </div>
            </div>
          </div>
    ...
    <script src="./js/isotope.js"></script>
     <script>
        ...
        jQuery(function ($) {
          ...
          // init Isotope
          var $container = $('.habits-wrapper').isotope({
